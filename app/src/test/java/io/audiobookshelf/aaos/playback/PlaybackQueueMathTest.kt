...
class PlaybackQueueMathTest {
    ...
    fun `maps resume position into matching track`() {
        val queue = listOf(
            ResolvedPlaybackTrack("1", "Teil 1", "https://example.com/1.mp3", "audio/mpeg", 60_000L, 0L),
            ResolvedPlaybackTrack("2", "Teil 2", "https://example.com/2.mp3", "audio/mpeg", 40_000L, 60_000L),
            ResolvedPlaybackTrack("3", "Teil 3", "https://example.com/3.mp3", "audio/mpeg", 30_000L, 100_000L),
        )
